...
tk.Label(root, text="IP remota:").grid(row=0, column=0, padx=10, pady=5)
...
btn_block = tk.Button(root, text="Bloquear el acceso", command=block_websites_remote, state=tk.DISABLED)
btn_block.grid(row=4, column=0, padx=10, pady=20)

btn_unblock = tk.Button(root, text="Permitir el Acceso", command=unblock_websites_remote, state=tk.DISABLED)
